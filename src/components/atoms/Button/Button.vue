...
<template>
  <button :type="type" :style="buttonStyles" :class="buttonClasses" :disabled="disabled || loading"
    @click="handleClick">
    <svg v-if="loading" style="animation: spin 1s linear infinite; margin-right: 8px; width: 16px; height: 16px;"
