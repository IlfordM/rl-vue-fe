...
const availableIcons = [
  "home", "user", "mail", "phone", "search", "trash", "coupon",
  "menu", "close", "arrow", "star", "rl", "lock", "logo", "bag",
  "bag-plus", "heart-plus", "dropdown", "cart", "cart-plus", "info",
  "heart", "search", "star-fill", "star-half", "star-empty"
]
